...
1. At Trixly, we have a single Trixly Open Source Contributor License Agreement that we ask contributors to electronically sign before merging in their
...
2. [Fork](https://github.com/kflash/Trixly/fork/) the repository and create your branch from master.
...
By contributing to Trixly, you agree that your contributions will be licensed under its MIT license.